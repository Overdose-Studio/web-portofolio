<template>
  <section class="bg-gray-500 dark:bg-gray-900 py-5 lg:py-10">
    <div
      class="px-4 mx-auto text-center justify-item-center md:max-w-screen-md lg:max-w-screen-lg"
    >
      <!-- Section Title -->
      <h2
      ...
      <!-- Button -->
      <div
        class="flex flex-row items-center md:mt-5 text-gray-500 sm:justify-between"
      >
        <!-- Coloumn -->
        <ul class="flex flex-row flex-wrap w-full pt-5 justify-center">
          <!-- Email -->
          <li>
            <a
